...
wget -O $HOME/.mineplex-chain/config/genesis.json https://server-3.itrocket.net/mainnet/crossfi/genesis.json
wget -O $HOME/.mineplex-chain/config/addrbook.json https://server-3.itrocket.net/mainnet/crossfi/addrbook.json
