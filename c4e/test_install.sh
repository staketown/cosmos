...
#curl -s https://raw.githubusercontent.com/chain4energy/c4e-chains/main/perun-1/genesis.json > $HOME/.c4e-chain/config/genesis.json
#curl -s https://share.utsa.tech/c4e/addrbook.json > $HOME/.c4e-chain/config/addrbook.json
